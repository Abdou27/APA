...
public class StatsDoctorCoursesFragment extends Fragment {
	...
	public static StatsDoctorCoursesFragment newInstance(String param1, String param2) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragment_stats_doctor_courses, container, false);
	}
}